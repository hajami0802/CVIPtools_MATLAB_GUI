...
% Last Modified by GUIDE v2.5 06-Mar-2023 14:42:13
...
%           Revision and Updated by : Hridoy  Biswas
...
% Revision History
%Revision 1.4  10/18/20 Hridoy
%  update inverse filter operatio to get correct histo information 
...
% Shrink the GUI
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pos =  get(handles.Trans,'position');
% pos(4) = 33;
set(handles.Trans,'position',pos)
...
elseif handles.pTF.Visible      %transform Filters
    ...
    if isempty(trans) || ( (210<trans)&& (trans<219)) == 0 %no spectral info
        %show Error info
        ...
        elseif handles.bHFE.Value==1 	%High Freq. Emphasis Filter
            ...
            histo = [235 block trans fch alfa ord];
%             234 2 trans m ord fch;

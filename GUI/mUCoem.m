function varargout = mUCoem(varargin)
% MUCOEM MATLAB code for mUCoem.fig
%      MUCOEM, by itself, creates a new MUCOEM or raises the existing
%      singleton*.
%
%      H = MUCOEM returns the handle to a new MUCOEM or the handle to
%      the existing singleton*.
%
%      MUCOEM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MUCOEM.M with the given input arguments.
%
%      MUCOEM('Property','Value',...) creates a new MUCOEM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mUCoem_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mUCoem_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mUCoem

% Last Modified by GUIDE v2.5 30-Jan-2022 19:12:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mUCoem_OpeningFcn, ...
                   'gui_OutputFcn',  @mUCoem_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mUCoem is made visible.
function mUCoem_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mUCoem (see VARARGIN)

% Choose default command line output for mUCoem
...
% --- Executes when ofm is resized.
function ofm_SizeChangedFcn(hObject, eventdata, handles)
% hObject    handle to ofm (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

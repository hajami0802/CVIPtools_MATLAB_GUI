function varargout = mU2I(varargin)
% MU2I MATLAB code for mU2I.fig
%      MU2I, by itself, creates a new MU2I or raises the existing
%      singleton*.
%
%      H = MU2I returns the handle to a new MU2I or the handle to
%      the existing singleton*.
%
%      MU2I('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MU2I.M with the given input arguments.
%
%      MU2I('Property','Value',...) creates a new MU2I or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mU2I_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mU2I_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mU2I

% Last Modified by GUIDE v2.5 30-Jan-2022 18:25:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mU2I_OpeningFcn, ...
                   'gui_OutputFcn',  @mU2I_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mU2I is made visible.
function mU2I_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mU2I (see VARARGIN)

% Choose default command line output for mU2I
...
% --- Executes when c2i is resized.
function c2i_SizeChangedFcn(hObject, eventdata, handles)
% hObject    handle to c2i (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

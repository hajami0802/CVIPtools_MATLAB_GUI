function varargout = mUCpratt(varargin)
% MUCPRATT MATLAB code for mUCpratt.fig
%      MUCPRATT, by itself, creates a new MUCPRATT or raises the existing
%      singleton*.
%
%      H = MUCPRATT returns the handle to a new MUCPRATT or the handle to
%      the existing singleton*.
%
%      MUCPRATT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MUCPRATT.M with the given input arguments.
%
%      MUCPRATT('Property','Value',...) creates a new MUCPRATT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mUCpratt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mUCpratt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mUCpratt

% Last Modified by GUIDE v2.5 30-Jan-2022 18:40:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mUCpratt_OpeningFcn, ...
                   'gui_OutputFcn',  @mUCpratt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mUCpratt is made visible.
function mUCpratt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mUCpratt (see VARARGIN)

% Choose default command line output for mUCpratt
...
if handles.bPratt.Value             	%perform Pratt Figure of Merit
...
% --- Executes when pratt is resized.
function pratt_SizeChangedFcn(hObject, eventdata, handles)
% hObject    handle to pratt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

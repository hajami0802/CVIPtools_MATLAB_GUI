...
% Last Modified by GUIDE v2.5 02-Aug-2023 00:02:52
...
%Add figure to group
group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hFig); 
figure(hFig);   
...
if hNfig == 0 || isempty(hNfig) || ~isfield(hNfig.UserData,'cvipIma')
    ...
    if isempty(hVhist)
        ...
        group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hVhist);
    end
...
% handles    structure with handles and user data (see GUIDATA)
%-----------------------------------
function mObjErrMat_Callback(hObject, eventdata, handles)
% hObject    handle to mPatt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clc;                             %clear screen
hOem=findobj('Tag','Oem');         %check if was previously opened
if isempty(hOem)
    hOem=DlgOem; %Call Anlysis-Geometry Form
    set(gcf,'Name','Objective Error Matrices','NumberTitle','off')
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hOem);
end

figure(hOem);
% --------------------------------------------------------------------
function mPre_Callback(hObject, eventdata, handles)
% hObject    handle to mPatt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clc;                             %clear screen
hPre=findobj('Tag','Prepro');         %check if was previously opened
if isempty(hPre)
    hPre=Preprocessing; %Call Anlysis-Geometry Form
    set(gcf,'Name','Preprocessing','NumberTitle','off')
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hPre);
end
figure(hPre);
...
if isempty(hGeo)
    ...
    updatemenus();          %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hGeo);
end
figure(hGeo);
...
if isempty(hEdg)
    ...
    updatemenus();          %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hEdg);
end
figure(hEdg);
...
if isempty(hSeg)
    ...
    updatemenus();          %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hSeg);
end
figure(hSeg);
...
if isempty(hTrans)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hTrans);
end
figure(hTrans);
...
if isempty(hFeat)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hFeat);
end
figure(hFeat);
...
if isempty(hPatt)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hPatt);
end
figure(hPatt);
...
if isempty(hEhisto)
    ...
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hEhisto);
...
if isempty(hEpseu)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hEpseu);
end
figure(hEpseu);
...
if isempty(hmESharp)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmESharp);
end
figure(hmESharp);
...
if isempty(hmESmo)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmESmo);
end
figure(hmESmo);
...
if isempty(hmRNoi)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmRNoi);
end
figure(hmRNoi);
...
if isempty(hmRspaF)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmRspaF);
end
figure(hmRspaF);
...
if isempty(hmRFreqF)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmRFreqF);
end
figure(hmRFreqF);
...
if isempty(hmRGeoT)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hmRGeoT);
end
figure(hmRGeoT);
...
if isempty(hCpre)
    ...
    updatemenus();             	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hCpre);
end
figure(hCpre);
...
if isempty(hCLes)
    ...
    updatemenus();            	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hCLes);
end
figure(hCLes);
...
if isempty(hCLos)
    ...
    updatemenus();            	%call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hCLos);
end
figure(hCLos);
...
if isempty(hCpos)
    ...
    updatemenus();              %call function to update
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hCpos);
end
figure(hCpos);
...
if hObject.UserData == 0          %show utilities menus hSutil(1).UserData
    g1data.mFile.Position=1;       %shange menu position tu redraw screen (3 to 2 to 1) (Modified on April 19 2023)
...
%     mypath = fullfile('mFiles', 'html', 'welcome.html');
% 
...
%     print(a);
 ...
 web(fullfile(docroot, '3ptoolbox/cviptoolboxtoolbox/doc/welcome.html'))
...
if isempty(hArith)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hArith);
end
...
if isempty(hFilt)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hFilt);
end
...
if isempty(hSize)
    ...
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hSize);
end
...
if isempty(hStats)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hStats);
end
...
if isempty(hEnh)
    ...
    if ~isempty(hPrev)         figure(hPrev);     end
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hEnh);
end
...
if isempty(hCrea)
    ...
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hCrea);
end
...
if isempty(hConv)
    ...
    if ~isempty(hPrev)         figure(hPrev);     end
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hConv);
end
...
% handles    structure with handles and user data (see GUIDATA)
clc;                             %clear screen
hComp=findobj('Tag','c2i');	%check if was previously opened
if isempty(hComp)
    hComp=mU2I;               %call Compare 2 Images Form
    set(gcf,'Name','Utilities->Compare->Compare Two Images','NumberTitle','off');
    hPrev=findobj('Tag',handles.mUtil.UserData);%check if was previously opened 
    if ~isempty(hPrev)         figure(hPrev);     end
    updatemenus();              %cheked for View information and save history
    group = setfigdocked('GroupName','CVIP Toolbox V.3.7','Figure',hComp);
end
...
% -------------------------------------
function mCOem_Callback(hObject, eventdata, handles)
% hObject    handle to mCOem (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

clc;                             %clear screen
hComp=findobj('Tag','ofm');	%check if was previously opened
if isempty(hComp)
    hComp=mUCoem;               %call Compare 2 Images Form
    set(gcf,'Name','Utilities->Compare->Objective Fidelity Metrices','NumberTitle','off');
    hPrev=findobj('Tag',handles.mUtil.UserData);%check if was previously opened 
    if ~isempty(hPrev)
        if ~isempty(hPrev)         figure(hPrev);     end
    end
...
hComp.UserData = 'OFM';       %indicate selected option
mUComp('Comp_SizeChangedFcn',hComp,eventdata,guidata(hComp));
figure(hComp);
% --------------------------------------------------------------------
% function mCOem_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
clc;                             %clear screen
hComp=findobj('Tag','pratt');	%check if was previously opened
if isempty(hComp)
    hComp=mUCpratt;               %call Compare 2 Images Form
    set(gcf,'Name','Utilities->Compare->Pratt Figure of Merit','NumberTitle','off');
    hPrev=findobj('Tag',handles.mUtil.UserData);%check if was previously opened 
    if ~isempty(hPrev)
        if ~isempty(hPrev)         figure(hPrev);     end
    end
...
% imshow('3ptoolbox/cviptoolboxtoolbox/GUI/Images/Background.png')
...
% % handles    structure with handles and user data (see GUIDATA)
% clc;                             %clear screen
% hPre=findobj('Tag','mPrepro');         %check if was previously opened
% if isempty(hPre)
%     hPre=Preprocessing; %Call Anlysis-Geometry Form
%     set(gcf,'Name','Preprocessing','NumberTitle','off')
%     updatemenus();              %cheked for View information and save history
...
% --------------------------------------------------------------------
function mPrepro_Callback(hObject, eventdata, handles)
% hObject    handle to mPrepro (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clc;                             %clear screen
hPre=findobj('Tag','Prepro');         %check if was previously opened
...
% --- Executes on key press with focus on txtIlist and none of its controls.
function txtIlist_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to txtIlist (see GCBO)

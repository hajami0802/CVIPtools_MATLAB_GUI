...
% Last Modified by GUIDE v2.5 28-Apr-2023 17:25:56
...
%handles for Adaptive Filters
 ...
 handles.popVar.Visible = 'On';
    ...
    handles.popThresh.Visible = 'Off';
    handles.popThresh.String = 'Off';
    handles.tThresh.Visible = 'Off';
    handles.tThresh.String = 'Off';
...
handles.bStand.Visible='Off';
handles.bPara.Visible='Off';
handles.bStand2.Visible = 'On';
%handles.bStand2.Value = 1;
handles.bPara2.Visible = 'On';
% handles.bPara2.String = 'Improved';
...
handles.bStand2.Visible='Off';
handles.bPara2.Visible='Off';
...
% --- Executes on button press in bStand2.
function bStand2_Callback(hObject, eventdata, handles)
% hObject    handle to bStand2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 handles.popVar.Visible = 'On';
    handles.popVar.String ={100;200;300;400;500;600;700;800.00};
...
% Hint: get(hObject,'Value') returns toggle state of bStand2


% --- Executes on button press in bPara2.
function bPara2_Callback(hObject, eventdata, handles)
% hObject    handle to bPara2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 handles.popVar.Visible = 'On';
    handles.popVar.String ={100;200;300;400;500;600;700;800.00};
...
% Hint: get(hObject,'Value') returns toggle state of bPara2
...
% --- Executes during object creation, after setting all properties.
function bgOrder_CreateFcn(hObject, eventdata, handles)
% hObject    handle to uibuttongroup5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

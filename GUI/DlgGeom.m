...
% Last Modified by GUIDE v2.5 28-Feb-2023 21:08:56
...
% Shrink the GUI
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pos =  get(handles.Geom,'position');
% pos(4) = 33;
set(handles.Geom,'position',pos)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
handles.hListe =  [handles.bCrop;...
    handles.bPast; ...
    handles.bResz;...
    handles.bRota; ...
    handles.bTrans; ...
    handles.bZoom; ...
    handles.uibuttongroup3; ...
    handles.text5; ...
    handles.text6; ...
    handles.zBy; ...
    handles.cCrop; ...

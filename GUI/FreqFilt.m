...
% Last Modified by GUIDE v2.5 05-Apr-2023 15:56:37
...
%             origImgData = but15Data.UserData; %Fields of Name and Image
%             noiseImgData = but14Data.UserData; %Fields of Name and Image
             OutIma = simple_wiener_filter_cvip(degradedImgData.Image,Mask,K);
%         end
...
% --- Executes on key press with focus on popupmenu42 and none of its controls.
function popupmenu42_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu42 (see GCBO)

...
handles.bJPEG.Enable='Off';
handles.bHuff.Enable='Off';
handles.bZiv.Enable='Off';
handles.mAna.Visible = 'On';%hide Analysis menu
handles.mComp.Visible = 'On';%hide Analysis menu
handles.mView.Visible = 'On';%hide Analysis menu

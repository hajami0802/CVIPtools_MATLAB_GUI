...
% Last Modified by GUIDE v2.5 08-Jun-2021 21:25:04
...
elseif handles.bEdge.Value==1	%Edhe enhancement   
    ...
    switch edMet
        case 1                  %HfE
            OutIma = highfreqemphasis_cvip(InIma, 'FFT', 128, 1.5, 4,'y',1);
            row = size(OutIma,1);
...
elseif handles.bPseu.Value==1          %perform Gray to Natural binary
    if handles.bGCfreq.Value           %by frequency mapping
        ...
        if size(unique([LPC BPC HPC])) < 3
            ...
            Filt = ideal_low_cvip(Spect, [], 0,'fft', Lfreq);%LPF
            LP = ifft_cvip(Filt,[]);        %LowPass Image
            Filt = ideal_bandpass_cvip(Spect, [],0,'fft', Lfreq, Hfreq);%BPF
            BP = ifft_cvip(Filt,[]);        %BandPass Image
            Filt = ideal_high_cvip(Spect, [],0, 'fft', Hfreq);%HPF
...
if strcmp(hObject.String(hObject.Value),'Unsharp Masking')
    ...
    handles.Un_T_l.Visible='On';
    handles.Un_T_h.Visible='On';
    %show Threshold level control
else
    ...
    handles.lblEdgeClip.Visible = 'Off';  
     handles.Un_T_l.Visible='Off';
    handles.Un_T_h.Visible='Off';%show Threshold level control
end
...
hide_all(handles);                  %hide all controls
handles.pHisStre.Visible = 'On';
handles.low_t.Visible='On'
handles.high_t.Visible='On'
...
hide_all(handles);              %hide all controls
handles.pSharp.Visible = 'On'; 
handles.sharp_T_L='on';
handles.sharp_T_H='on';%show specific controls
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clip = str2double(handles.popEHclip.String(handles.popEHclip.Value))*100
 clip=int2str(clip)
 clip=strcat(clip,'%')
 set(handles.Un_T_h,'String',clip)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clip = str2double(handles.popELclip.String(handles.popELclip.Value))*100
clip=int2str(clip)
clip=strcat(clip,'%')
set(handles.Un_T_l,'String',clip)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clip = str2double(handles.popSlclip.String(handles.popSlclip.Value))*100
 clip=int2str(clip)
 clip=strcat(clip,'%')
 set(handles.sharp_T_H,'String',clip)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clip = str2double(handles.popSHclip.String(handles.popSHclip.Value))*100
 clip=int2str(clip)
 clip=strcat(clip,'%')
 set(handles.sharp_T_L,'String',clip)
...
% --- Executes during object creation, after setting all properties.
function sharp_T_H_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sharp_T_H (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes during object creation, after setting all properties.
function sharp_T_L_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sharp_T_L (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes during object creation, after setting all properties.
function Un_T_l_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Un_T_l (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes during object creation, after setting all properties.
function Un_T_h_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Un_T_h (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

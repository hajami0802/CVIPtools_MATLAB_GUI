...
% if option ==3 && handles.pMeshR.Value==1 &&  handles.pMeshR.Value==1
%     errordlg('Please select another row and column except 1', 'Filter Error', 'modal');
%     
% end
mesh_size_r = handles.pMeshR.Value ;%-1
mesh_size_c = handles.pMeshC.Value ;
...
setfigdocked('GroupName','CVIP Toolbox V.3.61','Figure',fhm);

...
% Last Modified by GUIDE v2.5 02-Mar-2023 15:43:42
...
% Shrink the GUI
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pos =  get(handles.Edge,'position');
% pos(4) = 33;
set(handles.Edge,'position',pos)
...
elseif handles.bBoi.Value==1        %Boie-Cox edge detector
...
elseif handles.bHou.Value           %Hough filter
    ...
    switch handles.popsca.Value
        ...
        case 3 %Aftering ANDing Image
            Inverse_Hough_Image = hough_inverse_cvip(Hough_Image,RC_cell,LP);
...
handles.popsca.String = {'Hough Image'; 'Inverse Hough'; 'After ANDing';};
...
% --- Executes on button press in bBoi.
function bBoi_Callback(hObject, eventdata, handles)
% hObject    handle to bBoi (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of bBoi
%show and hide controls
handles.p1stEdge.Visible = 'Off';
handles.p3rdEdge.Visible = 'Off';

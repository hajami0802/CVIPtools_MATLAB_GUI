function phi = rst_invariant_cvip(labeledImage, objLabel,out_file_name, featSelect,n)
...
if n==0
  phi = [  obj_id feats_title ; out_file_name num2cell(objLabel) num2cell(feature_val) ];
else

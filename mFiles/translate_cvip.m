...
%==========================================================================
%% Revision History
 % Revision 1.3  03/10/2019  18:10:15 Hridoy   
 % Error while using negative number.Solved by giving condtion. 
 % line 104-116
% Revision History
...
%1st offset value
if shiftOffset(1,1)<0  
    shiftOffset(1,1)=M-(-(shiftOffset(1,1)));%1st condition get positive value
    if shiftOffset(1,1)<0 %2nd condition get positive value
        shiftOffset(1,1)=M-(-(shiftOffset(1,1)));
    end
end
%2nd offset value
if  shiftOffset(1,2)<0  
    shiftOffset(1,2)=N-(-(shiftOffset(1,2)));
    if shiftOffset(1,2)<0  
       shiftOffset(1,2)=N-(-(shiftOffset(1,2)));
    end
end

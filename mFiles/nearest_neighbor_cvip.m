function [Test, dista] = nearest_neighbor_cvip(file_tt, file_tr, ...
...
% Syntax :
% -------
% nearest_neighbor_cvip(file_tt, file_tr, file_out, option_normalize, option_distance,  varargin)
...
%                   classified based on their NN in training set.
%
%   'option_normalize':
% 
%     0 – No Normalization
...
%                   option_distance = 6;
%                   s_min = 0; s_max = 1;
%                   nearest_neighbor_cvip(file_tt, file_tr, file_out, option_normalize, option_distance, s_min, s_max)
%                  
%
% Example 2 :
% ---------
...
%                   s_min = 0; s_max = 1;
%                   r_minkowski = 3;
%                   nearest_neighbor_cvip(file_tt, file_tr, file_out, option_normalize, option_distance, s_min, s_max, r_minkowski)
%
%
%
% Example 3 :
...
%                   r_softmax = 5;
%                   r_minkowski = 3;
%                   nearest_neighbor_cvip(file_tt, file_tr, file_out, option_normalize, option_distance, r_softmax, r_minkowski)
% Reference
% ---------
    ...
    case 0  % No normalization
        switch option_distance
            ...
            case 2 % City block 
                ...
                distances = pattern_city_block_cvip(file_tt,file_tr);
                [dista,pos] = min(distances,[],2);
                Tr = readtable(file_tr);
                Test = readtable(file_tt);
                %extract class names                 
            ...
            case 3 % Maximum 
                ...
                distances = pattern_maximum_cvip(file_tt,file_tr);
                [dista,pos] = min(distances,[],2);
                Tr = readtable(file_tr);
                Test = readtable(file_tt);
                %extract class names                 
            ...
            case 5 % Vector inner product
                ...
                distances = pattern_vector_inner_product_cvip(file_tt,file_tr);
            ...
            case 6 % Tanimoto metric
                ...
                distances = pattern_tanimoto_cvip(file_tt,file_tr);
                [dista,pos] = max(distances,[],2);
                Tr = readtable(file_tr);
                Test = readtable(file_tt);
                %extract class names                 
